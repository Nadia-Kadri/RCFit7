...
const Schedule = ({ userId }) => {
    ...
    API.userSchedule()
      .then(res => {
        ...
        for (let i = 0; i < res.data.length; i++) {
          let isSignedUp;
          let found = res.data[i].users.some(user => user === userId);
        ...
        const signUpSchedulesArr = schedulesArr.filter(e => {
          return e.datetime < moment().add(7, "days");
        });
        setSchedules(signUpSchedulesArr);
      })
      .catch(err => console.log(err));
  };

  const userSignUp = scheduleId => {
  ...
  return (
    <Fragment>
            ...
            <div className="card bg-light mb-3 custCard upcomingLeft">
              <div className="card-body">
                ...
                <div className="card-text">
                  <h6>
                    Below are this week's upcoming classes, click Sign-Up to
                    reserve your spot!
                  </h6>

                  <div className="upcomingClassesTitle">
                  ...
                  <table className="table table-hover table-sm">
                    <tbody>
                      <UpcomingSchedules
                        ...
                        tableDate={moment().format("MMDDYY")}
                      />
                    </tbody>
                  </table>
          ...
          <div className="col-lg-5 upcomingRight">
            <div className="textContainer">
              <div className="textOne">
                <span id="textBelieve">BELIEVE</span> IN
              </div>
              <div className="textTwo">YOURSELF</div>
              <div className="textThree">
                AND <span id="textYou">YOU</span> WILL BE
              </div>
      ...
      <LoginModal />
      <SignUpModal getSchedules={getSchedules} />
      <CancelModal getSchedules={getSchedules} />
    </Fragment>
  );
};
