...
const Schedule = (props) => (
  <tr>
    ...
    <td>{props.title}</td>
    <td>{props.trainer}</td>
    <td><span className="btn btn-outline-warning delete-schedule-button text-center" id={props.id} onClick={() => props.onClickViewUsers(props.id)} data-toggle="modal" data-target="#viewUsers" >X</span></td>
